...
import { getStudentCollaborationThunk } from '../../thunks/studentDetailThunkWithID'

const studentCollaborationsSlice = createSlice({
    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(
            getStudentCollaborationThunk.fulfilled,
            (state, action) => {
...
export default studentCollaborationsSlice.reducer
