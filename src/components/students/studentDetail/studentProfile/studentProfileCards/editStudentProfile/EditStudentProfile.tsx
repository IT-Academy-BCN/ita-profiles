...
export const EditStudentProfile: React.FC<EditStudentProfileProps> = ({
    ...
    const aboutData = useAppSelector(
        (state) => state.ShowStudentReducer.studentDetails.aboutData,
    )
    const editProfileModalIsOpen = useAppSelector(
        (state) =>
            state.ShowStudentReducer.studentDetails.editProfileModalIsOpen,
    )
    ...
    const handleProfileImage = () => {
        dispatch(setToggleProfileImage())
    }
                ...
                <div className="w-[400px] h-[90%] md:h-[80%] max-h-[800px] m-0 flex flex-col border border-[rgba(128,128,128,1)] rounded-xl bg-white p-[37px] pb-4 pt-4 pr-4">
                    ...
                    <div className="w-full h-full ">
                        ...
                        <form
                            ...
                            onSubmit={handleSubmit(handleButtonSubmit)}
                        >
