...
const DragAndDropLanguages: FC<TDragAndDropLanguagesProps> = ({
    dropLanguages,
    deleteLanguage,
    editLanguage,
}) => {
    ...
    const { updateLanguagesDrop, handleDragStart, handleDragOver, handleDrop } =
        useDragAndDropLanguagesHook(dropLanguages)
