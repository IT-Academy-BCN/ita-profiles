                        ...
                        (training: TAdditionalTraining, index) => (
                            ...
                            >
                                ...
                                <div className="flex flex-col ">
                                    ...
                                    {index !==
                                        additionalTraining.length - 1 && (
                                            <span className="h-px w-full bg-gray-4-base md:bg-gray-5-background my-3" />
                                        )}
                                    {
                                        // "id": "123e4567-e89b-12d3-a456-426614174000",
                                        // "course_name": "Python for Financial Data Analysis",
                                        // "study_center": "FutureTech Learning Center",
                                        // "course_beginning_year": 2022,
                                        // "course_ending_year": 2023,
                                        // "duration_hrs": 250
                                    }
                                </div>
                            </div>
