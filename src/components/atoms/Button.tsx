...
const outlineButtonStyles = 'bg-white text-stone-500 font-bold py-6 rounded-xl border border-gray-500 hover:bg-[#EBCDE4] hover:border-[#781555] hover:text-primary-hover active:bg-[#D89CC8] active:border-[#C0559F] active:text-primary-hover disabled:bg-white disabled:text-disabled disabled:border-disabled'
