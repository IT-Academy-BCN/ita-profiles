...
describe('LoginPopup', () => {
    ...
    test('calls login and navigates on successful form submission', async () => {
        mockAxios.onPost('http://localhost:8000/api/v1/signin').reply(200, {
            userID: 'user1',
            token: 'token123',
        })
    ...
    test('shows error message on failed form submission', async () => {
        mockAxios.onPost('http://localhost:8000/api/v1/signin').reply(401)
        ...
        const projectsElement = screen.getByText(
