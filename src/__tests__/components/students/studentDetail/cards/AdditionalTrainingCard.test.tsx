...
import AdditionalTrainingCard from '../../../../../components/students/studentDetail/cards/AdditionalTrainingCard'
...
describe('AdditionalTrainingCard', () => {
    ...
    it('should fetch the student Additional Training correctly', async () => {
        ...
        mock.onGet(
            `//localhost:8000/api/v1/student/${studentUUID}/resume/additionaltraining`,
