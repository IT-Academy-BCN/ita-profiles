...
import StudentFiltersContent from '../../../../../components/students/studentDetail/filters/StudentFiltersContent'
...
describe('FetchStudentsList function', () => {
    ...
    it('should fetch student list for home', async () => {
        ...
        const expectedUrl =
            '/student/resume/list?specialization=role1,role2'
    ...
    it('should handle errors', async () => {
        ...
        const expectedUrl = '/student/resume/list'
