...
describe('BootcampCard component', () => {
  it("renders bootcamp data correctly", () => {
    ...
    mock.onGet(`//localhost:8000/api/v1/student/c24ce043-a214-454e-8152-d3255722f70c/resume/bootcamp`).reply(200, mockResponse)
    ...
    waitFor(() => expect(screen.getByText('Reskilling - Full Stack PHP')).toBeInTheDocument())
    waitFor(() => expect(screen.getByText('Fullstack PHP')).toBeInTheDocument())
  })
})