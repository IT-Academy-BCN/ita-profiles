...
class StudentListController extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        /* El method __invoke devuelve un array de coincidencias en formato JSON, utilizando el servicio
        'studentListService' y teniendo en cuenta los parámetros del request. Además, devuelve un mensaje de error
