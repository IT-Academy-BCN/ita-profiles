...
class ResumeTagDeleteServiceTest extends TestCase
{
    ...
    public function testRemovesSpecifiedTagsFromResume(): void
    {
        ...
        $resume->save();
        // Ejecutar el servicio para eliminar etiquetas especificadas del currículum
        $this->resumeTagDeleteService->removespecifiedTags([$tags[0]->id, $tags[1]->id]);

        // Verificar que las etiquetas especificadas se hayan eliminado del currículum
        $resume->refresh();
