...
class TagUpdateControllerTest extends TestCase
{
    ...
    public function testReturnsUnprocessableContentWhenMissingTagName(): void
    {
        ...
        $response->assertJson([
            'message' => 'El camp tag name és obligatori.',
            'errors' => [
                'tag_name' => [
    ...
    public function testReturnsUnprocessableContentWithDuplicateName(): void
    {
        ...
        $response->assertStatus(422);
        $response->assertJson([
            'message' => 'Tag name ja està registrat i no es pot repetir.',
            'errors' => [
                'tag_name' => [
    ...
    public function testUpdateTagFailsWhenTagNameIsMissing(): void
    {
        $tag = $this->tag;

        $response = $this->putJson(route('tag.update', ['tagId' => $tag->id]), []);
